# ESPAsync_WiFiManager Library (Updated)

![GitHub Release](https://img.shields.io/github/v/release/pvergezac/ESPAsync_WiFiManager)
![GitHub Release Date](https://img.shields.io/github/release-date/pvergezac/ESPAsync_WiFiManager)
...
![GitHub Issues or Pull Requests](https://img.shields.io/github/issues/pvergezac/ESPAsync_WiFiManager)

#### This fork is updated with :

- Uptodate and not patched library dependancies :
  - **AsyncTCP/ESP32Async**
  - **ESP32Async/ESPAsyncWebServer**
- Resolve buid errors and conflicts with libraries used by your project
- Can now be used with :
  - [**ElegantOTA**](https://github.com/ayushsharma82/ElegantOTA) library
  - [**PlatformIO**](https://platformio.org/platformio-ide) IDE
  - **espressif32** and [**platformio/espressif32**](https://github.com/platformio/platform-espressif32) platform
...
- [ESPAsync_WiFiManager Library (Updated)](#espasync_wifimanager-library-updated) - [This fork is updated with :](#this-fork-is-updated-with-)
  - [Table of Contents](#table-of-contents)
    ...
    - [Why do we need this Async ESPAsync_WiFiManager library](#why-do-we-need-this-async-espasync_wifimanager-library)
      - [Features](#features)
  ...
  - [Documentation](#documentation)
    ...
    - [Debug Terminal Output Samples](#debug-terminal-output-samples)
      - [1. Async_ConfigOnDRD_FS_MQTT_Ptr_Medium on ESP32_DEV](#1-async_configondrd_fs_mqtt_ptr_medium-on-esp32_dev)
        - [1.1 No Config Data =\> Config Portal](#11-no-config-data--config-portal)
        - [1.2. Config Portal Done](#12-config-portal-done)
      - [2. Async_ConfigOnDRD_FS_MQTT_Ptr_Complex on ESP8266_NODEMCU_ESP12E](#2-async_configondrd_fs_mqtt_ptr_complex-on-esp8266_nodemcu_esp12e)
        - [2.1 With Config Data =\> Run normally](#21-with-config-data--run-normally)
        - [2.2. DRD =\> Config Portal](#22-drd--config-portal)
        - [2.3. Config Portal Done](#23-config-portal-done)
      ...
      - [11. Async_ConfigOnDoubleReset on ESP32S3_DEV using LittleFS](#11-async_configondoublereset-on-esp32s3_dev-using-littlefs)
      - [12. Async_ConfigOnDoubleReset on ESP32C3_DEV using LittleFS](#12-async_configondoublereset-on-esp32c3_dev-using-littlefs)
    - [Debug](#debug)
...
1. To use CORS feature with **default** CORS Header "_". Some WebBrowsers won't accept this allowing-all "_" CORS Header.
...
Submit issues to: [ESPAsync_WiFiManager issues](https://github.com/pvergezac/ESPAsync_WiFiManager/issues)
...
<table>
  ...
  <tr>
    ...
    <td align="center"><a href="https://github.com/pvergezac"><img src="https://github.com/pvergezac.png" width="100px;" alt="pvergezac"/><br /><sub><b>PVergezac</b></sub></a><br /></td>
  </tr>
</table>
